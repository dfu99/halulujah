...
OUTPUT_JSONL = f"NVDA_500_batches/fixbatch_{INPUT_YEAR}.jsonl"
MODEL = "gpt-4o"
...
def format_prompt(question, answer, context, year):
    ...
    prompt = (
        ...
        f"If the question, answer, or the context do not reference any year, "
        f"rephrase them to include the year {year}. Do not change the answer. "
        f"Output the modified CSV line only, preserving the CSV format."
    )
    return prompt
