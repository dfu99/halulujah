...
- [2026-04-25] *4B 5x5 specialist-pair grid* (run_collab_matrix.py, N=50): WHO-asymmetry persists at 4B (row spread 49.5pp, col 18pp, 2.75x ratio) but specific harmed/helped domains FLIP from 1.7B PACE study. Math becomes most-helped (+41.5pp), medicine moves from -37.8 to +9.5, law/physics become harmed. The asymmetry is universal but its shape is config-dependent. obj-032.
- [2026-04-24] *Token-space + subtopic + reasoning-recall mechanism follow-ups*: ALL weak. r(JS, delta)=+0.275, r(primary entropy, row-mean)=-0.380, r(subtopic count, row-mean)=-0.169, r(%reasoning, row-mean)=+0.233. Direction partly opposite to §5.1 hypothesis. Mechanism remains open; §5 reports honestly. obj-030, obj-031.
- [2026-04-23] *Paper spine pivot v2*: societies-of-agents WHO-asymmetry replaces LoRA-vs-FT as headline. New Figure 1 = 10x10 heatmap. ANOVA-driven (primary 13.1% vs helper 0.5%, 26x). Memory anchored at memory/feedback_paper_spine.md. obj-029.
- [2026-04-23] *Streaming CKA on 10 LoRA adapters*: r(pairwise weight-space similarity, collab delta) = -0.055. LoRA adapters uniformly impaired, not differentially so. obj-028.
- [2026-04-23] *4B full-FT scale-invariance datapoint* (N=200): solo 87.0%, ft+base 90.5%, Δ +3.5pp, C2W/W2C = 9/4 = 2.25×. With 4B medicine (+5.0pp, 1.4×) and 4B physics (+1.5pp, 1.8×), scale-invariance evidence at 4B now spans 3 domains, all in the healthy C2W/W2C range (1.4–2.25×). Law full-FT training next, then math, then LoRA r=128 on biology/law/math, then r=32/r=64 fill-ins on medicine/physics.
