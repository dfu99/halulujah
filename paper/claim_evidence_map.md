...
| Triangulation table (post-§6vv) | **27 row-effect tests; 5+ helper-effect tests, all helper-side n.s.** Twenty-five tests reject H0 of no row effect (✓); two are direction-only (⚠: §6qq subject-level mutual-unrec confound resolved by §6rr/§6ss; §6vv 0/10 BH-FDR on easy). Helper-effect tests all non-rejecting at every stratification level. See `tasks/audit-2026-05-05.md` §10 8th revision for the canonical paragraph. |
