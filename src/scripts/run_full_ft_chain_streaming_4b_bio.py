...
DOMAINS = [
    # Biology 4B Full FT corruption recovery (2026-05-10).
    # The original 4B bio final on WD_BLACK had 52/398 tensors zeroed
    # at model.layers.31+, caused by the save_model SIGKILL when the
    # pre-volume-upgrade moosefs ~21 GB quota tripped mid-write.
    # Pod volume is now 60 GB so the save_model write fits cleanly.
    ("biology", "pubmedqa"),
]
